...
# Working Copy (wc)
alias gwcs='git status --ignore-submodules=$_git_status_ignore_submodules --short'
alias gwcS='git status --ignore-submodules=$_git_status_ignore_submodules'
alias gwcd='git diff --no-ext-diff'
alias gwcD='git diff --no-ext-diff --word-diff'
alias gwcr='git reset --soft'
alias gwcR='git reset --hard'
alias gwcc='git clean --dry-run'
alias gwcC='git clean --force'
alias gwcx='git rm -r'
alias gwcX='git rm -r --force'
